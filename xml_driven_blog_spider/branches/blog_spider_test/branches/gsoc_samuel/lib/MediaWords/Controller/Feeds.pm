...
sub scrape : Local
{
    ...
    else
    {
        ...
        my $links = Feed::Scrape::MediaWords->get_valid_feeds_from_index_url( $url, $c, $ignore_patterns );
...
sub delete : Local
{
    ...
    my ($deleteme_tags_id) = $c->dbis->query("select tags_id from tags t, tag_sets ts " . 
