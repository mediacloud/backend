...
-- versions 4395 and 4396.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4395, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4396, import this SQL file:
--
--     psql mediacloud < mediawords-4395-4396.sql
--
