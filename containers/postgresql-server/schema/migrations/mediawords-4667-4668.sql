...
-- versions 4667 and 4668.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4667, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4668, import this SQL file:
--
--     psql mediacloud < mediawords-4667-4668.sql
--
