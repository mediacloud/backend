...
my $_url_permission_types = {
    ...
    '/api/v2/topics/generate_word2vec_model'           => 'topics_write',
    ...
    '/api/v2/topics/snapshots/generate_word2vec_model' => 'topics_write',
...
my $_url_transformations = {
    ...
    '/api/v2/topics/generate_word2vec_model'      => '/api/v2/topics/~topics_id~/generate_word2vec_model',
    ...
    '/api/v2/topics/snapshots/generate_word2vec_model' =>
      '/api/v2/topics/~topics_id~/snapshots/~dummy_id~/generate_word2vec_model',
