...
Switch the active sole index to the collection.  Delete everything currently in that collection.  Run a
full solr import based on the current postgres db.

Using this function leaves the side effect of leaving all of the test data sitting in the collection after
it has been run.
