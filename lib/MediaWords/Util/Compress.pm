...
use Inline Python => MediaWords::Util::Config::get_mc_python_dir() . '/mediawords/util/compress.py';
...
sub bzip2($)
{
    ...
    unless ( IO::Compress::Bzip2::bzip2 \$encoded_data => \$bzipped2_data, BlockSize100K => 9 )
    {
...
sub gzip($)
{
    ...
    unless ( IO::Compress::Gzip::gzip \$encoded_data => \$gzipped_data, -Level => Z_BEST_COMPRESSION, Minimal => 1 )
    {
