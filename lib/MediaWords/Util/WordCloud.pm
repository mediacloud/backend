...
sub get_word_cloud
{
    ...
    for my $word ( @{ $words } )
    {
        my $url = _get_uri_for_word_cloud_word( $c, $word );
...
sub get_multi_set_word_cloud
{
    ...
    for my $word ( @all_words )
    {
        ...
        if ( $set eq 'list_1' )
        {
            $word_cloud_list_class = "word_cloud_list1";

        }
        elsif ( $set eq 'list_2' )
        {
            $word_cloud_list_class = "word_cloud_list2";

        }
        elsif ( $set eq 'both' )
        {
            $word_cloud_list_class = "word_cloud_both_lists";
