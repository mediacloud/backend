...
# test feed checksumming in MediaWords::Crawler::Handler::Feed::Syndicated
...
"http://au.ibtimes.com/articles/454410/20130408/portugal-government-sticks-to-bailout-goals-despite-court-ruling.htm",
    ...
    is( MediaWords::Crawler::Handler::Feed::Syndicated::_stories_checksum_matches_feed( $db, $feed->{ feeds_id }, $stories_a ),
        0, "empty checksum" );
    ...
    is( MediaWords::Crawler::Handler::Feed::Syndicated::_stories_checksum_matches_feed( $db, $feed->{ feeds_id }, $stories_b ),
        0, "fail 1" );
    ...
    is( MediaWords::Crawler::Handler::Feed::Syndicated::_stories_checksum_matches_feed( $db, $feed->{ feeds_id }, [] ), 0, "fail 3" );
