...
sub main
{
    ...
    #my $cleaned_data = MaxEntUtils::purge_false_features_and_references( \@out_data );

    my $cleaned_data = \@out_data;
	...
	my $files = MaxEntUtils::output_testing_and_training( $cleaned_data, $current_part, $folds );
