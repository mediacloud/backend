...
-- versions 4426 and 4427.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4426, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4427, import this SQL file:
--
--     psql mediacloud < mediawords-4426-4427.sql
--
...
alter table cd.live_stories add db_row_last_updated timestamp with time zone;
