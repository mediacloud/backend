...
-- versions 4398 and 4399.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4398, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4399, import this SQL file:
--
--     psql mediacloud < mediawords-4398-4399.sql
--
