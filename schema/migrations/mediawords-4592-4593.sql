...
-- versions 4592 and 4593.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4592, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4593, import this SQL file:
--
--     psql mediacloud < mediawords-4592-4593.sql
--
