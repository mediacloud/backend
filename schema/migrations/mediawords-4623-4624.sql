...
-- versions 4623 and 4624.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4623, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4624, import this SQL file:
--
--     psql mediacloud < mediawords-4623-4624.sql
--
