...
-- versions 4379 and 4388.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4379, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4388, import this SQL file:
--
--     psql mediacloud < mediawords-4379-4388.sql
--
