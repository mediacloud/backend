...
-- versions 4565 and 4566.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4565, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4566, import this SQL file:
--
--     psql mediacloud < mediawords-4565-4566.sql
--
