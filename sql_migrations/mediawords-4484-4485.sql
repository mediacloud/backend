...
-- versions 4484 and 4485.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4484, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4485, import this SQL file:
--
--     psql mediacloud < mediawords-4484-4485.sql
--
...
DECLARE
    ...
    MEDIACLOUD_DATABASE_SCHEMA_VERSION CONSTANT INT := 4485;
