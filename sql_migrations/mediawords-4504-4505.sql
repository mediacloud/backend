...
-- versions 4504 and 4505.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4504, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4505, import this SQL file:
--
--     psql mediacloud < mediawords-4504-4505.sql
--
