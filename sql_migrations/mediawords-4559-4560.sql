...
-- versions 4559 and 4560.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4559, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4560, import this SQL file:
--
--     psql mediacloud < mediawords-4559-4560.sql
--
