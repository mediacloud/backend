...
-- versions 4491 and 4492.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4491, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4492, import this SQL file:
--
--     psql mediacloud < mediawords-4491-4492.sql
--
