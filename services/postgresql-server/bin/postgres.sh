...
MC_POSTGRESQL_BIN_DIR="/usr/lib/postgresql/10/bin/"
MC_POSTGRESQL_DATA_DIR="/var/lib/postgresql/10/main/"
MC_POSTGRESQL_CONF_PATH="/etc/postgresql/10/main/postgresql.conf"
