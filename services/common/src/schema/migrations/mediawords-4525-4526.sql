...
-- versions 4525 and 4526.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4525, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4526, import this SQL file:
--
--     psql mediacloud < mediawords-4525-4526.sql
--
