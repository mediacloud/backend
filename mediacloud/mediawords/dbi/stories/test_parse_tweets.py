...
from mediawords.dbi.stories.parse_tweets import (
find_tweets_in_html,
_find_if_tweet_is_embedded,
)
...
class TestParseTweets(TestDatabaseWithSchemaTestCase):
    ...
    def test_find_tweets_in_html(self) -> None:
        ...
        '</span><a href="https://twitter.com/DrDavidDuke/status/799624219\
831058432" target="_blank"><span>demanded</span></a><span> that the Senat\
e "<span class="InternetLink">': 
        [{'user':'DrDavidDuke', 
          'id': '799624219831058432', 
          'embedded': False}]

        '"twitter-tweet"><p lang="en" dir="ltr">Who can figure out the tru\
e meaning of "covfefe" ??? Enjoy!</p>— Donald J. Trump (@realDonaldTrump) \
<a href="https://twitter.com/realDonaldTrump/status/869858333477523458?ref\
_src=twsrc%5Etfw">May 31, 2017</a></blockquote> <script async="" src="http\
s://platform.twitter.com/widgets.js" "twitter-tweet"><p lang="en" dir="ltr\
">Who can figure out the true meaning of "covfefe" ??? Enjoy!</p>— Donald \
J. Trump (@realDonaldTrump) <a href="https://twitter.com/realDonaldTrump/s\
tatus/869858333477523458?ref_src=twsrc%5Etfw">May 31, 2017</a></blockquote\
> <script async="" src="https://platform.twitter.com/widgets.js" ': 
        [{'user': 'realDonaldTrump', 
          'id': '869858333477523458', 
          'embedded': True}, 
         {'user': 'MerriamWebster', 
          'id': '869782666572443648', 
          'embedded': True}]
