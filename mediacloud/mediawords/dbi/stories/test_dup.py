...
from mediawords.dbi.stories.dup import _get_title_parts, _get_story_date_range, get_medium_dup_stories_by_title
...
def test_get_medium_dup_stories_by_title() -> None:
    ...
    # sa = {'title': 'foo', 'url': 'http://foo.com/foo', 'publish_date': '2018-01-01'}
    # sa = {'title': 'foo', 'url': 'http://foo.com/foo', 'publish_date': '2018-01-01'}
    # sa = {'title': 'foo', 'url': 'http://foo.com/foo', 'publish_date': '2018-01-01'}
    # sa = {'title': 'foo', 'url': 'http://foo.com/foo', 'publish_date': '2018-01-01'}
    # sa = {'title': 'foo', 'url': 'http://foo.com/foo', 'publish_date': '2018-01-01'}
    ...
    assert get_medium_dup_stories_by_title([sa, sb, sc]) == [[sb, sc]]
