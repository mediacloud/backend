...
from mediawords.solr.run.constants import (
    ...
    MC_SOLR_CLUSTER_ZOOKEEPER_HOST, MC_SOLR_CLUSTER_ZOOKEEPER_PORT, MC_SOLR_SIGKILL_TIMEOUT,
    MC_SOLR_STANDALONE_JVM_OPTS, MC_SOLR_LUCENEMATCHVERSION, MC_SOLR_STANDALONE_PORT,
