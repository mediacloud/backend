...
def run_re_tests():
    ...
    validate_re( '( foo and bar )', '(?: (?: [[:<:]]foo .* [[:<:]]bar ) | (?: [[:<:]]bar .* [[:<:]]foo ) )' )
    validate_re( 'foo and bar and baz and bat', '(?: (?: [[:<:]]foo .* (?: (?: [[:<:]]bar .* (?: (?: [[:<:]]baz .* [[:<:]]bat ) | (?: [[:<:]]bat .* [[:<:]]baz ) ) ) | (?: (?: (?: [[:<:]]baz .* [[:<:]]bat ) | (?: [[:<:]]bat .* [[:<:]]baz ) ) .* [[:<:]]bar ) ) ) | (?: (?: (?: [[:<:]]bar .* (?: (?: [[:<:]]baz .* [[:<:]]bat ) | (?: [[:<:]]bat .* [[:<:]]baz ) ) ) | (?: (?: (?: [[:<:]]baz .* [[:<:]]bat ) | (?: [[:<:]]bat .* [[:<:]]baz ) ) .* [[:<:]]bar ) ) .* [[:<:]]foo ) )' )
    validate_re( 'foo bar', '(?: [[:<:]]foo | [[:<:]]bar )' )
    validate_re( '( foo bar )', '(?: [[:<:]]foo | [[:<:]]bar )' )
    validate_re( '( 1 or 2 or 3 or 4 )', '(?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 | [[:<:]]4 )' )

    # more complex boolean
    validate_re( 'foo and ( bar baz )', '(?: (?: [[:<:]]foo .* (?: [[:<:]]bar | [[:<:]]baz ) ) | (?: (?: [[:<:]]bar | [[:<:]]baz ) .* [[:<:]]foo ) )' )
    validate_re( '( foo or bat ) and ( bar baz )', '(?: (?: (?: [[:<:]]foo | [[:<:]]bat ) .* (?: [[:<:]]bar | [[:<:]]baz ) ) | (?: (?: [[:<:]]bar | [[:<:]]baz ) .* (?: [[:<:]]foo | [[:<:]]bat ) ) )' )
    validate_re( 'foo and bar and baz and bat and ( 1 2 3 )', '(?: (?: [[:<:]]foo .* (?: (?: [[:<:]]bar .* (?: (?: [[:<:]]baz .* (?: (?: [[:<:]]bat .* (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) ) | (?: (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) .* [[:<:]]bat ) ) ) | (?: (?: (?: [[:<:]]bat .* (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) ) | (?: (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) .* [[:<:]]bat ) ) .* [[:<:]]baz ) ) ) | (?: (?: (?: [[:<:]]baz .* (?: (?: [[:<:]]bat .* (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) ) | (?: (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) .* [[:<:]]bat ) ) ) | (?: (?: (?: [[:<:]]bat .* (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) ) | (?: (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) .* [[:<:]]bat ) ) .* [[:<:]]baz ) ) .* [[:<:]]bar ) ) ) | (?: (?: (?: [[:<:]]bar .* (?: (?: [[:<:]]baz .* (?: (?: [[:<:]]bat .* (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) ) | (?: (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) .* [[:<:]]bat ) ) ) | (?: (?: (?: [[:<:]]bat .* (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) ) | (?: (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) .* [[:<:]]bat ) ) .* [[:<:]]baz ) ) ) | (?: (?: (?: [[:<:]]baz .* (?: (?: [[:<:]]bat .* (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) ) | (?: (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) .* [[:<:]]bat ) ) ) | (?: (?: (?: [[:<:]]bat .* (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) ) | (?: (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) .* [[:<:]]bat ) ) .* [[:<:]]baz ) ) .* [[:<:]]bar ) ) .* [[:<:]]foo ) )' )
    validate_re( '( ( ( a or b ) and c ) or ( d or ( f or ( g and h ) ) ) )', '(?: (?: (?: (?: [[:<:]]a | [[:<:]]b ) .* [[:<:]]c ) | (?: [[:<:]]c .* (?: [[:<:]]a | [[:<:]]b ) ) ) | [[:<:]]d | [[:<:]]f | (?: (?: [[:<:]]g .* [[:<:]]h ) | (?: [[:<:]]h .* [[:<:]]g ) ) )' )
    ...
    validate_re( '( 1 or 2 or 3 ) and "foz fot"', "(?: (?: (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) .* [[:<:]]foz[[:space:]]+fot ) | (?: [[:<:]]foz[[:space:]]+fot .* (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) ) )" )
    validate_re( '( 1 or 2 or "foo bar-baz" ) and "foz fot"', "(?: (?: (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]foo[[:space:]]+bar\-baz ) .* [[:<:]]foz[[:space:]]+fot ) | (?: [[:<:]]foz[[:space:]]+fot .* (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]foo[[:space:]]+bar\-baz ) ) )" )
