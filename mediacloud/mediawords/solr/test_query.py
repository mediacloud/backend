...
def test_re():
    ...
    __validate_re('( foo and bar )', '(?: (?: [[:<:]]foo .* [[:<:]]bar ) | (?: [[:<:]]bar .* [[:<:]]foo ) )')
    __validate_re('foo and bar and baz and bat',
    ...
    # more complex boolean
    __validate_re('foo and ( bar baz )',
                  '(?: (?: [[:<:]]foo .* (?: [[:<:]]bar | [[:<:]]baz ) ) | (?: (?: [[:<:]]bar | [[:<:]]baz ) .* [[:<:]]foo ) )')
    __validate_re('( foo or bat ) and ( bar baz )',
                  '(?: (?: (?: [[:<:]]foo | [[:<:]]bat ) .* (?: [[:<:]]bar | [[:<:]]baz ) ) | (?: (?: [[:<:]]bar | [[:<:]]baz ) .* (?: [[:<:]]foo | [[:<:]]bat ) ) )')
    __validate_re('foo and bar and baz and bat and ( 1 2 3 )',
    ...
    __validate_re('( ( ( a or b ) and c ) or ( d or ( f or ( g and h ) ) ) )',
    ...
    __validate_re('( 1 or 2 or 3 ) and "foz fot"',
                  "(?: (?: (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) .* [[:<:]]foz[[:space:]]+fot ) | (?: [[:<:]]foz[[:space:]]+fot .* (?: [[:<:]]1 | [[:<:]]2 | [[:<:]]3 ) ) )")
    __validate_re('( 1 or 2 or "foo bar-baz" ) and "foz fot"',
    ...
    __validate_re(candidate_query, candidate_re)
    ...
    __validate_re(coh_query, coh_re)
    ...
    __validate_re(school_query, school_re)
    ...
    __validate_re(gender_query, gender_re)
