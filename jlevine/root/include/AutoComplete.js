    ...
    */
    function AutoComplete_ShowDropdown(id)
    {
        ...
        for (i=0;  (i<__AutoComplete[id]['data'].length ) && ( toDisplay.length < __AutoComplete[id]['maxitems'] ); ++i) {
            //if (__AutoComplete[id]['data'][i].substr(0, value.length) == value) {
            if (__AutoComplete[id]['data'][i].toLowerCase().indexOf(value.toLowerCase()) > -1) {
