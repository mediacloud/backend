...
-- versions 4665 and 4666.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4665, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4666, import this SQL file:
--
--     psql mediacloud < mediawords-4665-4666.sql
--
