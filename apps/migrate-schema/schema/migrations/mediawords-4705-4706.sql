...
-- versions 4705 and 4706.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4705, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4706, import this SQL file:
--
--     psql mediacloud < mediawords-4705-4706.sql
--
...
DECLARE
    ...
    MEDIACLOUD_DATABASE_SCHEMA_VERSION CONSTANT INT := 4706;
BEGIN
