...
-- versions 4526 and 4527.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4526, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4527, import this SQL file:
--
--     psql mediacloud < mediawords-4526-4527.sql
--
