...
my $_url_permission_types = {
    ...
    '/api/v2/topics/add_seed_query'               => 'topics_write',
    ...
    '/api/v2/topics/list_tiemspan_files'                         => 'topics_read',
    '/api/v2/topics/list_snapshot_files'                         => 'public',
    '/api/v2/topics/media/list'                   => 'topics_read',
    '/api/v2/topics/media/list_maps'              => 'topics_read',
    ...
    '/api/v2/topics/remove_seed_query'            => 'topics_write',
    ...
    '/api/v2/topics/stories/links'                => 'topics_read',
...
my $_url_transformations = {
    '/api/v2/topics/add_seed_query'               => '/api/v2/topics/~topics_id~/add_seed_query',
    ...
    '/api/v2/topics/list_timespan_files'                   => '/api/v2/topics/~topics_id~/list_timespan_files',
    '/api/v2/topics/list_snapshot_files'                   => '/api/v2/topics/~topics_id~/list_snapshot_files',
    '/api/v2/topics/media/list'                   => '/api/v2/topics/~topics_id~/media/list',
    '/api/v2/topics/media/list_maps'              => '/api/v2/topics/~topics_id~/media/list_maps',
    '/api/v2/topics/media/links'                  => '/api/v2/topics/~topics_id~/media/links',
    ...
    '/api/v2/topics/remove_seed_query'            => '/api/v2/topics/~topics_id~/remove_seed_query',
    ...
    '/api/v2/topics/stories/links'            => '/api/v2/topics/~topics_id~/stories/list',
