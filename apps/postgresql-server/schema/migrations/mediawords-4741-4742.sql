...
-- versions 4741 and 4742.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4741, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4742, import this SQL file:
--
--     psql mediacloud < mediawords-4741-4742.sql
--
