...
-- versions 4690 and 4691.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4690, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4691, import this SQL file:
--
--     psql mediacloud < mediawords-4690-4691.sql
--
