...
-- versions 4723 and 4724.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4723, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4724, import this SQL file:
--
--     psql mediacloud < mediawords-4723-4724.sql
--
