...
-- versions 4750 and 4751.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4750, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4751, import this SQL file:
--
--     psql mediacloud < mediawords-4750-4751.sql
--
