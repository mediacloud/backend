...
-- versions 4706 and 4707.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4706, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4707, import this SQL file:
--
--     psql mediacloud < mediawords-4706-4707.sql
--
