...
-- versions 4573 and 4574.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4573, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4574, import this SQL file:
--
--     psql mediacloud < mediawords-4573-4574.sql
--
