...
-- versions 4722 and 4723.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4722, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4723, import this SQL file:
--
--     psql mediacloud < mediawords-4722-4723.sql
--
