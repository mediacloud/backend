...
-- versions 4651 and 4652.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4651, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4652, import this SQL file:
--
--     psql mediacloud < mediawords-4651-4652.sql
--
