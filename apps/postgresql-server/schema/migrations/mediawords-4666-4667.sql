...
-- versions 4666 and 4667.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4666, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4667, import this SQL file:
--
--     psql mediacloud < mediawords-4666-4667.sql
--
