...
-- versions 4674 and 4675.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4674, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4675, import this SQL file:
--
--     psql mediacloud < mediawords-4674-4675.sql
--
...
CREATE OR REPLACE FUNCTION copy_chunk_of_nonpartitioned_sentences_to_partitions(start_stories_id INT, end_stories_id INT) RETURNS INT AS $$
