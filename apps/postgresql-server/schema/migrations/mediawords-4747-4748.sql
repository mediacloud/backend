...
-- versions 4747 and 4748.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4747, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4748, import this SQL file:
--
--     psql mediacloud < mediawords-4747-4748.sql
--
