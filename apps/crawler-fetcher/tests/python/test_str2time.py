...
def __dt_to_ts(dt: datetime.datetime) -> int:
    return int(time.mktime(dt.timetuple()))


def test_str2time_21st_century():
    assert str2time_21st_century('1961-01-01') == __dt_to_ts(datetime.datetime(1961, 1, 1, 0, 0, 0)), "Year 1961"
    assert str2time_21st_century('2061-01-01') == __dt_to_ts(datetime.datetime(2061, 1, 1, 0, 0, 0)), "Year 2061"

    assert str2time_21st_century('2016-08-23T23:32:11-04:00') == __dt_to_ts(datetime.datetime(
        year=2016,
        month=8,
        day=23,
        hour=23,
    ...
    start_of_year = __dt_to_ts(datetime.datetime(2061, 1, 1, 0, 0, 0))
    end_of_year = __dt_to_ts(datetime.datetime(2061, 12, 31, 23, 59, 59))

    for date_in_2061 in dates_in_2061:
        timestamp = str2time_21st_century(date_in_2061)
        assert timestamp, f"Timestamp for date '{date_in_2061}' is defined."
        assert start_of_year <= timestamp <= end_of_year, f"Timestamp for date '{date_in_2061}' is within range."
